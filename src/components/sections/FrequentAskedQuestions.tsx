  ...
  const faqs = [
    {
      ...
      answer:
        '<p>A. Com desconto: Valor válido para inscrições pagas à vista ou em até 3 parcelas sem juros, exclusivamente pelo Pagseguro. Até 20 dias antes do início do módulo.</p><p>B. Sem desconto: Valor válido para inscrições pagas após o prazo do desconto ou para parcelamento em qualquer tempo acima de 4 parcelas.</p><p>1. À vista:<ul><li>- Cartão de crédito/débito do sistema Cielo**;</li><li>- Depósito/transferência/Pix Banco Itaú;</li><li>Boleto do sistema PagSeguro*.</li></ul></p><p>2. Valor sem desconto: Parcelado em até 6 vezes, sem juros, no cartão de crédito do sistema Cielo**.</p><p> 3. Parcelado em até 18 vezes, com juros, no cartão de crédito do sistema PagSeguro*.</p><p>4. Valor com desconto: Parcelado em até 3 vezes, sem juros, no cartão de crédito do sistema PagSeguro*. Ou de 4 a 18 parcelas com juros.</p><p>Bandeiras aceitas:</p><p>* Aceita Visa, Mastercard, ELO e Diners</p><p>*** Aceita Visa, Mastercard, ELO, Diners, Ourocard, AMEX, Hipercard e outros.</p>'
    },
    {
      id: 11,
