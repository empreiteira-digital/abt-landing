    ...
    <section className="course--section">
      <div className="course--wrapper container mx-auto flex flex-col items-center">
        ...
        <div className="course--box-wrapper">
          <div className="course--box course-card-even course-card-1 even">
          ...
          <div className="course--box course-card-odd course-card-2 odd">
            <div className="text--wrapper">
          ...
          <div className="course--box course-card-odd course-card-4 odd">
            <div className="text--wrapper">
              <span className="font-semibold">
              ...
              alunos, que agregaram às suas competências profissionais o
              aprofundamento em um dos assuntos mais desafiadores, cruciais e
              urgentes da atualidade.
            </div>
          </div>
          <div className="course--box course-card-even course-card-5 even">
            <div className="text--wrapper">
              <span className="font-semibold">
